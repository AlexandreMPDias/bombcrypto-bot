...
class MouseManager:
    def __init__(self, gui: pyautogui, cv: CompVision, config: Config):
        ...
        self.use_click_and_drag_instead_of_scroll = config.get(
            'use_click_and_drag_instead_of_scroll')
        self.click_and_drag_amount = config.get('click_and_drag_amount')
        self.scroll_size = config.get('scroll_size')
